...
function startLoading() {
  loadingInterval = setInterval(function () {
    ...
    process.stdout.write("\r".concat(frameText, " package\uC5D0 \uC791\uC131\uB41C \uB77C\uC774\uBE0C\uB7EC\uB9AC\uB97C yarn\uC73C\uB85C install \uD558\uACE0 \uC788\uC5B4 \uAE30\uB2E4\uB824\uC8FC\uC138\uC694"));
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          if (confirmation.toLowerCase() === 'y') {
            ...
            console.log('yarn install 선택안함으로 진행함');
          }
        case 4:
        case "end":
